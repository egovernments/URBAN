const envVariables = {
  ...
  KAFKA_TOPICS_RECEIPT_CREATE_REGEX:
    process.env.KAFKA_TOPICS_RECEIPT_CREATE_REGEX || (process.env.KAFKA_TOPICS_RECEIPT_CREATE ? new RegExp(process.env.KAFKA_TOPICS_RECEIPT_CREATE) : /.*egov\.collection\.payment-create$/i),
