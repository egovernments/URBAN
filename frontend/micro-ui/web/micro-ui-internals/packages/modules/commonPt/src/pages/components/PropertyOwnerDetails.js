  ...
  const [ownerDetails, setOwnerDetails] = React.useState([
    {
      ...
      mobileNumber: isNewApplication
    ? userInfo?.info?.mobileNumber : (formData.owners && formData.owners[index] && formData.owners[index].mobileNumber) || formData?.owners?.mobileNumber || "",
      fatherOrHusbandName:
