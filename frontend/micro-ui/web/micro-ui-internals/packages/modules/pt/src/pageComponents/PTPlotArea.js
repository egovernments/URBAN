...
const PTPlotArea = ({ t, onSelect }) => {
  ...
  return (
    <LabelFieldPair style={{ display: "block" }}>
      <CardLabel className="card-label-smaller" style={{marginBottom:"0px",display:"contents"}}>{t("Plot Area")}</CardLabel>
      <div className="" >
        <TextInput
