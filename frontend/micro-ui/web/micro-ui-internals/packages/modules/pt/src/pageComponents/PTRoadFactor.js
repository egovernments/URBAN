...
const PTRoadFactor = ({ t, config, onSelect, userType, formData, formState, setError, clearErrors, onBlur }) => {
    ...
    return (
      <React.Fragment>
        <LabelFieldPair style={{ display: "block" }}>
          <CardLabel className="card-label-smaller" style={{marginBottom:"0px",display:"contents"}}>{t("Road Factor") + " *"}</CardLabel>
          <Dropdown
