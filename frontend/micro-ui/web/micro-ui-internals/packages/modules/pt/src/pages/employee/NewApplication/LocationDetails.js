    ...
    return (
        <div>
            ...
            <div style={style2.grid}>
                <div style={style2.flex30}><label style={style2.label}>Latitude<span style={{ color: "red" }}>*</span></label><TextInput style={style2.widthInput}  /></div>
                <div style={style2.flex30}><label style={style2.label}>Longitude<span style={{ color: "red" }}>*</span></label><TextInput style={style2.widthInput}  /></div>
                <div style={style2.flex30}>   {renderFileInput("ownershipDoc", "Property Photograps", true)} </div>
