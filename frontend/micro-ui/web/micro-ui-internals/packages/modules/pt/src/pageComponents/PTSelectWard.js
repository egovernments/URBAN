...
const PTSelectWard = ({ t, config, onSelect, userType, formData, setError, clearErrors, formState }) => {
  ...
  if (userType === "employee") {
    ...
    <React.Fragment>
        <LabelFieldPair style={{ alignItems: "center", display: "block" }}>
          <CardLabel className="card-label-smaller" style={{display:"contents",marginBottom:"0px",lineHeight:"inherit"}}>{t("Ward") + " *"}</CardLabel>
          <Controller
            name="locality"
            defaultValue={null}
            control={control}
