...
<div style={styles.formSection}>
  ...
  {/* <div style={styles.flex30}>
    <div style={{ ...styles.poppinsLabel, color: "#888" }}>{t("Property Type")}</div>
    <Dropdown
  ...
  <div style={styles.flex30}>
    <div style={{ ...styles.poppinsLabel, color: "#888" }}>{t("Rooms/Area")}</div>
    <TextInput
      style={styles.widthInput}
      placeholder={t("Enter")}
  ...
  {/* Exemption */}
  <div style={styles.flex30}>
    <div style={{ ...styles.poppinsLabel, color: "#888" }}>{t("Exemption Applicable")}</div>
    <Dropdown
      style={styles.widthInput}
      t={t}
      option={[
...
<div style={styles.checkboxContainer}>
  <label style={{ color: "#888", marginRight: "2rem" }}>
    {t("Mobile Tower")}{" "}
    <input
      type="checkbox"
