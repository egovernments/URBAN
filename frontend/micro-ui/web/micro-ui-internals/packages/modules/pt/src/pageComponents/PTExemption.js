...
const PTExemption = ({ t, config, onSelect, userType, formData, formState, setError, clearErrors, onBlur }) => {
  ...
  if (userType === "employee") {
    return (
      <React.Fragment>
        <LabelFieldPair style={{ alignItems: "center", display: "block" }}>
          <CardLabel className="card-label-smaller" style={{display:"contents",marginBottom:"0px",lineHeight:"inherit"}}>{t("Exemption Applicable") + " *"}</CardLabel>
          <Dropdown
