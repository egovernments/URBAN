...
const PTSelectZone = ({ t, config, onSelect, userType, formData, setError, clearErrors, formState }) => {
  ...
  if (userType === "employee") {
    return (
 <React.Fragment>
        <LabelFieldPair style={{ display:"block", alignItems: "center" }}>
          <CardLabel className="card-label-smaller" style={{display:"content",marginBottom:"0px",lineHeight:"inherit"}}>{t("Zone") + " *"}</CardLabel>
          <Controller
            name="locality"
            defaultValue={null}
            control={control}
