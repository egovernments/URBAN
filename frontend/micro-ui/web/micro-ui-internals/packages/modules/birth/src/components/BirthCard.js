...
const BirthCard = () => {
  ...
  // Define the links that will ALWAYS show for citizens
  const citizenLinks = [
    {
  ...
  const propsForModuleCard = {
    ...
    kpis: [],
    // Use the 'isCitizen' switch to decide which links to show
