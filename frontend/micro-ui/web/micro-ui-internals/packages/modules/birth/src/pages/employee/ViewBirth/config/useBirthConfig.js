        ...
        sections: [
          ...
          },
          {
            ...
            values: [
              ...
              { key: t("BND_CITY_LABEL"), value: birthCertData.BirthCertificate[0].birthPresentaddr.city || "-" },
              { key: t("BND_STATE_LABEL"), value: birthCertData.BirthCertificate[0].birthPresentaddr.state || "-" },
              { key: t("BND_PINNO_LABEL"), value: birthCertData.BirthCertificate[0].birthPresentaddr.pinno || "-" },
              { key: t("BND_COUNTRY_LABEL"), value: birthCertData.BirthCertificate[0].birthPresentaddr.country || "-" },
            ],
          },
          {
            type: "DATA",
