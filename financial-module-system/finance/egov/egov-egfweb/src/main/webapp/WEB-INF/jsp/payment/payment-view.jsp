...
<body >
	...
	<form:form action="payment" theme="simple">
		<!-- TODO: Manual migration required for custom Struts tag -->
			...
			<span class="mandatory1"> <!-- TODO: Manual migration required for custom Struts tag --> <!-- TODO: Manual migration required for custom Struts tag --></span>
														...
														<table width="100%" border="0" cellspacing="0"
															...
															<tr>
																...
																<c:if test="%{shouldShowHeaderField('department')}">
																	...
																	<td class="greybox">${%{getMasterName('department')}}</td>
																</c:if>
																...
																<td colspan="6">
																	<div style="float: left; width: 100%;">
																		<table id="miscBillTable" align="center" border="0"
																			...
																			<c:if test="%{miscBillList.size>0}">
																				<c:forEach var="p" value="miscBillList" status="s">
																					<tr>
																						...
																						<td style="text-align: center"
																							...
																							<a href="#" onclick="openVoucher('<!-- TODO: Manual migration required for custom Struts tag -->');">
																								 ${%{billVoucherHeader.voucherNumber}}
																						    </a>
																						</td>		 
																						<td style="text-align: center"
																							class="blueborderfortdnew"><s:date
