...
/**
 * Controller for the receipt register report
 */
@Controller
...
public class ReceiptRegisterReportController {
    ...
    @GetMapping("/receiptRegisterReport-criteria")
    public String criteria(Model model) {
        // TODO: Add bank branch list to model
        ...
        // TODO: Add department list to model
        ...
        return "reports/receiptRegisterReport-index";
    }

    @PostMapping("/receiptRegisterReport-report")
    public void report(@RequestParam(value = "fromDate", required = false) Date fromDate,
        ...
        response.getWriter().write("Receipt Register Report - From: " + fromDate + ", To: " + toDate);
    }

    protected String getReportTemplateName() {
        return "collection_receipt_register_report";
    }
